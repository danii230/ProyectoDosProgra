...
//    }
    @Test
    public void objetReturnByNumberNameTest() throws JDOMException, IOException {

        Images resultado = (Images) fileArmacabeza.objetAReturnByNumber("xml", 2);
    ...
    public void objetReturnByNumberUrlTest() throws JDOMException, IOException {
        ...
        Images resultado = (Images) fileArmacabeza.objetAReturnByNumber("xml", 3);
    ...
    public void objetReturnByNumberImageNumberTest() throws JDOMException, IOException {
        ...
        Images resultado = (Images) fileArmacabeza.objetAReturnByNumber("xml", 4);
...
//    @Test
//    public void listImageToStringTest() throws JDOMException, IOException {
//        LinkedList<Images> resultado = fileArmacabeza.listImage("xml");
...
//
//        String resultado2 = resultado.get(2).toString1();
//        String esperado2 = esperado.get(2).toString1();
//        System.out.println(resultado2);
//        System.out.println(esperado2);
//        assertEquals(resultado2, esperado2);
//
...
//
//    @Test
//    public void listImageNameTest() throws JDOMException, IOException {
//        LinkedList<Images> resultado = fileArmacabeza.listImage("xml");
//        LinkedList<Images> esperado = new LinkedList();
//        esperado.add(new Images("001-wine", 1, 30, 30, "Icon/001-wine.png"));
//        esperado.add(new Images("002-vegetables", 2, 30, 30, "Icon/002-vegetables.png"));
